...
# Date  : 2026-07-22
################################################################
"""1D conditional UNet noise predictor (ManiSkill / Chi et al. Diffusion Policy)."""
...
class ConditionalResidualBlock1D(nn.Module):
    def __init__(
        ...
        # FiLM: per-channel scale and bias from conditioning.
...
class ConditionalUnet1D(nn.Module):
    """Noise prediction UNet over action sequences with FiLM global conditioning."""
